...
class TaskFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'limit_date' => ['type' => 'timestamp', 'length' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        ...
        'description' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'limit_date' => 1548722127,
                'status' => 1,
                'priority_id' => 1,
                'description' => 'Lorem ipsum dolor sit amet',
                'create_date' => 1548722127
            ],
        ];
        parent::init();
    }
